...
function App() {
  ...
  const [urlOther, setOtherUrl] = useState(
    "https://tom.imgix.net/s3toixjs.mp4"
  ); //Second url that is a non HLS file
    ...
    <div className='App'>
      ...
      <header className='App-header'>
        <p class='regular-text'>
          This app is used to showcase the user experience of playing an mp4 vs
          an HLS video with imgix. To test this, right-click on the browser and
          select "inspect", click the Network tab, change the speed to Fast 3G,
          and make sure the "disable cache" button next to it is selected.
        </p>
